package com.anda.moments.views.popup;
...
//		mScreenHeight = Util.getScreenHeight(mContext);
        ...
        // 设置弹窗的布局界面
        View view = LayoutInflater.from(mContext).inflate(R.layout.popup_comment, null);
        setContentView(view);
        ...
        meng = (TextView)view.findViewById(R.id.popu_meng);

        priase.setOnClickListener(onclick);
        comment.setOnClickListener(onclick);
        meng.setOnClickListener(onclick);
    }
