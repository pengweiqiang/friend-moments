...
public class AskShareAapter extends BaseListAdapter {
	
	private Context mContext;
	private List<PartTimeJob> mData;
	private LayoutInflater mLayoutInflater;
	
	public AskShareAapter(Context mContext,List<PartTimeJob> mData){
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if(convertView == null){
			convertView = mLayoutInflater.inflate(R.layout.ask_share_item, null);
