 ...
 *
 */
public class SchoolAmbassdaorMainFragment extends BaseFragment{

	View mContentView;
	
	private SchoolAmbassdaorFragment mSchoolAmbassdaorFragment;
	...
	public Fragment getInstanceById(int id){
    	switch (id) {
		case 0:
			if(mSchoolAmbassdaorFragment == null){
				mSchoolAmbassdaorFragment = new SchoolAmbassdaorFragment();
			}
			return mSchoolAmbassdaorFragment;
