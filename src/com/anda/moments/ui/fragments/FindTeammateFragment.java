...
import com.anda.moments.apdater.FindTeamMateAapter;
 ...
 * 
 */
public class FindTeammateFragment extends BaseFragment implements
	...
	private FindTeamMateAapter mListAdapter;
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		mContentView = inflater.inflate(R.layout.find_teammate, container,
				false);
		mActionBar = (ActionBar) mContentView.findViewById(R.id.actionBar);
		mActionBar.setTitle("找个队友");
	...
	public void onActivityCreated(Bundle savedInstanceState) {
		...
		mListAdapter = new FindTeamMateAapter(mActivity, mData);
