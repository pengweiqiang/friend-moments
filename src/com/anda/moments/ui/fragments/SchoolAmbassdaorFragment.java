 ...
 *
 */
public class SchoolAmbassdaorFragment extends BaseFragment{

	private View mContentView;
	private ActionBar mActionBar;
	
	View mOutSourceQuestion,mOutSourceSchool,mOutSourceOnLine;
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		mContentView = inflater.inflate(R.layout.school_ambassdaor, container,false);
		mActionBar = (ActionBar)mContentView.findViewById(R.id.actionBar);
//		mActionBar.setTitle(R.string.tab_school_ambassador);
		mActionBar.hideLeftActionButton();
		
		
		mOutSourceQuestion = mContentView.findViewById(R.id.out_source_read);
		mOutSourceSchool = mContentView.findViewById(R.id.outSourceing);
		mOutSourceOnLine = mContentView.findViewById(R.id.out_source_entrance);
	...
	private void initListener(){
		mOutSourceQuestion.setOnClickListener(onClickListener);
		mOutSourceSchool.setOnClickListener(onClickListener);
		mOutSourceOnLine.setOnClickListener(onClickListener);
	}
...
//			});
	...
	private void getAdLists() {
		...
		ads.add("drawable://" + R.drawable.extension_image);
