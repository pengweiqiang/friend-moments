 ...
 *
 */
public class ShareExperienceFragment extends BaseFragment implements OnRefreshListener,IXListViewListener{
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		mContentView = inflater.inflate(R.layout.share_experience, container,false);
		mActionBar = (ActionBar)mContentView.findViewById(R.id.actionBar);
		mActionBar.setTitle("经历分享");
