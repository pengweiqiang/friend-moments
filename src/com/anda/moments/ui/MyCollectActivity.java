 ...
 *
 */
public class MyCollectActivity extends BaseActivity implements OnRefreshListener,IXListViewListener{
	...
	public void initView() {
		...
		mActionBar.setRightActionButton(new OnClickListener() {
	...
	private android.view.View.OnClickListener screenOnClickListener = new OnClickListener() {
		...
		public void onClick(View v) {
			switch (v.getId()) {
			case R.id.radio_part_time:
//				openRotation(mContentView.findViewById(R.id.down1));
				break;
			case R.id.radio_outsourcing:
