 ...
 *******************************************************************************/
package com.anda.universalimageloader.core;
...
import com.anda.universalimageloader.cache.disc.DiscCacheAware;
import com.anda.universalimageloader.cache.disc.impl.UnlimitedDiscCache;
import com.anda.universalimageloader.cache.disc.naming.FileNameGenerator;
import com.anda.universalimageloader.cache.memory.MemoryCacheAware;
import com.anda.universalimageloader.cache.memory.impl.FuzzyKeyMemoryCache;
...
import com.anda.universalimageloader.core.decode.ImageDecoder;
import com.anda.universalimageloader.core.download.ImageDownloader;
import com.anda.universalimageloader.core.download.NetworkDeniedImageDownloader;
import com.anda.universalimageloader.core.download.SlowNetworkImageDownloader;
import com.anda.universalimageloader.core.process.BitmapProcessor;
import com.anda.universalimageloader.utils.L;
import com.anda.universalimageloader.utils.MemoryCacheUtils;
import com.anda.universalimageloader.utils.StorageUtils;
...
public final class ImageLoaderConfiguration {
	...
	public static class Builder {
		 ...
		 * {@link com.anda.universalimageloader.cache.memory.impl.LruMemoryCache LruMemoryCache} will be used as
		 ...
		 * Default value - {@link com.anda.universalimageloader.cache.memory.impl.LruMemoryCache LruMemoryCache}
		 ...
		 * <b>NOTE:</b> If you use this method then
		 * {@link com.anda.universalimageloader.cache.disc.impl.TotalSizeLimitedDiscCache TotalSizeLimitedDiscCache}
		 ...
		 * By default: disc cache is unlimited.<br />
		 * <b>NOTE:</b> If you use this method then
		 * {@link com.anda.universalimageloader.cache.disc.impl.FileCountLimitedDiscCache FileCountLimitedDiscCache}
		 * will be used as disc cache. You can use {@link #discCache(DiscCacheAware)} method for introduction your own
		 * implementation of {@link DiscCacheAware}
		 */
		 ...
		 * Default value -
		 * {@link com.anda.universalimageloader.core.DefaultConfigurationFactory#createFileNameGenerator()
		 ...
		 * Default value -
		 * {@link com.anda.universalimageloader.core.DefaultConfigurationFactory#createImageDownloader(Context)
		 ...
		 * Default value -
		 * {@link com.anda.universalimageloader.core.DefaultConfigurationFactory#createImageDecoder(boolean)
		 ...
		 * Default value - {@link com.anda.universalimageloader.cache.disc.impl.UnlimitedDiscCache
		 * UnlimitedDiscCache}. Cache directory is defined by
		 * {@link com.anda.universalimageloader.utils.StorageUtils#getCacheDirectory(Context)
		 ...
		 * Consider {@link com.anda.universalimageloader.utils.L#disableLogging()} to disable ImageLoader logging completely (even error logs)
		 */
