 ...
 *******************************************************************************/
package com.anda.universalimageloader.core.imageaware;
 ...
 * through {@link com.anda.universalimageloader.core.ImageLoader ImageLoader}.
 * It can wrap any Android {@link android.view.View View} which can be accessed by {@link #getWrappedView()}. Wrapped
 * view is returned in {@link com.anda.universalimageloader.core.listener.ImageLoadingListener ImageLoadingListener}'s
 * callbacks.
 *
...
public interface ImageAware {
	...
	/**
	 * Returns {@linkplain com.anda.universalimageloader.core.assist.ViewScaleType scale type} which is used for
	 ...
	 * {@link com.anda.universalimageloader.core.listener.ImageLoadingListener#onLoadingCancelled(String,
	 ...
	 * {@linkplain com.anda.universalimageloader.core.DisplayImageOptions.Builder#showImageForEmptyUri(
	 *android.graphics.drawable.Drawable) for empty Uri},
	 * {@linkplain com.anda.universalimageloader.core.DisplayImageOptions.Builder#showImageOnLoading(
	 *android.graphics.drawable.Drawable) on loading} or
	 * {@linkplain com.anda.universalimageloader.core.DisplayImageOptions.Builder#showImageOnFail(
	 *android.graphics.drawable.Drawable) on loading fail}. These drawables can be specified in
	 * {@linkplain com.anda.universalimageloader.core.DisplayImageOptions display options}.<br />
	 * Also can be called in {@link com.anda.universalimageloader.core.display.BitmapDisplayer BitmapDisplayer}.
	 *
	 ...
	 * {@link com.anda.universalimageloader.core.display.BitmapDisplayer BitmapDisplayer}.
	 *
